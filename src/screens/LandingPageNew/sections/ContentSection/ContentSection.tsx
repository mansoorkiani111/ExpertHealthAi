    ...
    <Card className="w-full max-w-[342px] h-[151px] flex flex-col items-center justify-center gap-1 relative rounded-[20px] shadow-[0px_4px_4px_#00000040] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[20px] before:[background:linear-gradient(90deg,rgba(67,126,235,1)_0%,rgba(96,47,230,1)_50%,rgba(67,126,235,1)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
      <CardContent className="p-0 flex flex-col items-center justify-center w-full">
        ...
        <p className="w-[311px] [font-family:'Poppins',Helvetica] font-normal text-black text-base text-center tracking-[0] leading-[normal]">
          Seamlessly integrate with your EHR and send patient instructions via
          email.
        </p>
      </CardContent>
    </Card>
